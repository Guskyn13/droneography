...
const isActiveStyle = "flex items-center px-5 gap-3 text-white font-extrabold border-r-2 border-black transition-all duration-200 ease-in-out capitalize";
        ...
        <div className="flex flex-col justify-between bg-black h-full overflow-y-scroll min-w-210 hide-scrollbar">
            <div className="flex flex-col">
                <Link to="/" className="flex px-5 gap-2 my-6 pt-1 w-190 items-center" onClick={handleCloseSidebar}>
                    <img src={droneIcon} alt="logo" className="w-full" />
                </Link>
                <div className="flex flex-col gap-5">
                    ...
                    <h3 className="mt-2 px-5 text-white 2xlLtext-xl">Discover Categories</h3>
            ...
            {user && (
                <Link 
                    ...
                    className="flex my-5 mb-3 gap-2 p-2 items-center bg-gray-500 rounded-lg shadow-lg mx-3"
                    onClick={handleCloseSidebar}
                >
                    <img src={user.image}
